...
class Algorithm:
    ...
    def __init__(self, numberOfChromosomes, replaceByGeneration, trackBest, prototype ):
        ...
        self.currentGeneration = 0
         # Add a list to store fitness values of all chromosomes in each generation
        self.averageFitnessValues = []
    ...
    def Start(self):
        ...
        while 1:
            ...
            print("Generation:", self.currentGeneration, "Fitness:", best.GetFitness())  # Print generation number and fitness

            best_fitness_score.append(best.GetFitness())

            #avg_fitness = sum(population_fitness) / len(population_fitness)
            #avg_fitness_score.append(avg_fitness)
            number_of_generation.append(self.currentGeneration)

            # Start of a new generation
            generationFitnessValues = []
            ...
            for chromosome in self.chromosomes:
                ...
                generationFitnessValues.append(avg_fitness)  # Store the fitness value for this chromosome


            # calculate avg fitness for the current gen
            avg_fitness_generation = sum(generationFitnessValues) / len(generationFitnessValues)
            average_fitness_score.append(avg_fitness_generation)
            ...
            if best.GetFitness() >= 1:
                ...
                # return best
                # break
                print("Best fitness reached:", best.GetFitness())
                end_time = time.time()  # Record the end time
                execution_time = end_time - start_time  # Calculate the execution time

                print("Timetable generation completed in", execution_time, "seconds")
...
##        self.setPalette(palette)
    ...
    def alg(self):
        ...
        # print('array1', best_fitness_score)
        # print('array2', number_of_generation)
        # print('array3', average_fitness_score)
        end_time = time.time()  # Record the end time
        execution_time = end_time - start_time  # Calculate the execution time

        print("Genetic algorithm completed in", execution_time, "seconds")
        global best
        best = True
